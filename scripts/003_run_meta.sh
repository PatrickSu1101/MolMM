...
python 000_run_multi.py -n CNN_pH_kfold_val_meta_guide_inv_stop -d results/meta_sub -c1 ckpt/meta_sub -l 1 -t substrates_classes
python 000_run_multi.py -n CNN_pH_kfold_val_meta_guide_inv_full -d results/meta_sub -c1 ckpt/meta_sub -l 1 -t substrates_classes
python 000_run_multi.py -n CNN_pH_kfold_val_meta_guide_inv_freeze -d results/meta_sub -c1 ckpt/meta_sub -l 1 -t substrates_classes
