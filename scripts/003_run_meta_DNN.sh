...
# python 000_run_multi.py -n CNN_pH_kfold_meta_freeze -d results/meta_sub -c1 ckpt/meta_sub -l 1 -t substrates_classes
...
# python 000_run_multi.py -n CNN_pH_kfold_meta_proto_freeze -d results/meta_sub -c1 ckpt/meta_sub -l 1 -t substrates_classes

# python 000_run_multi.py -n CNN_pH_kfold_meta_multi_stop -d results/meta_sub -c1 ckpt/meta_sub -l 1 -t substrates_chem substrates_classes
...
# best model
# python 000_run_multi.py -n CNN_pH_kfold_val_meta_guide_stop -d results/meta_sub -c1 ckpt/meta_sub -l 1 -t substrates_classes
# python 000_run_multi.py -n CNN_pH_kfold_val_meta_guide_full -d results/meta_sub -c1 ckpt/meta_sub -l 1 -t substrates_classes
# python 000_run_multi.py -n CNN_pH_kfold_val_meta_guide_freeze -d results/meta_sub -c1 ckpt/meta_sub -l 1 -t substrates_classes
...
python 000_run_multi.py -n DNN_pH_kfold_val_meta_guide_inv_stop -d results/meta_sub -c1 ckpt/meta_sub -l 1 -t substrates_classes
python 000_run_multi.py -n DNN_pH_kfold_val_meta_guide_inv_full -d results/meta_sub -c1 ckpt/meta_sub -l 1 -t substrates_classes
python 000_run_multi.py -n DNN_pH_kfold_val_meta_guide_inv_freeze -d results/meta_sub -c1 ckpt/meta_sub -l 1 -t substrates_classes
python 000_run_multi.py -n DNN_pH_kfold_nval_meta_guide_inv_stop -d results/meta_inh -c1 ckpt/meta_inh -l 1 -t inhibitors_classes
python 000_run_multi.py -n DNN_pH_kfold_nval_meta_guide_inv_full -d results/meta_inh -c1 ckpt/meta_inh -l 1 -t inhibitors_classes
python 000_run_multi.py -n DNN_pH_kfold_nval_meta_guide_inv_freeze -d results/meta_inh -c1 ckpt/meta_inh -l 1 -t inhibitors_classes
